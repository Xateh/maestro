...
## Subagents
- For implementation work, spawn subagents using the `xcodex` alias's `gpt-5.3-codex-spark xhigh` model where possible. If that is unavailable, fall back to the default subagent.
